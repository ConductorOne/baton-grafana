...
Configuring the connector requires credentials generated in your Grafana instance. The credentials you need depend on whether you are connecting to **Grafana Cloud** or a **self-hosted Grafana** instance.
...
Enter your credentials based on your Grafana deployment type:
   ...
   - **Grafana Cloud**: paste your service account token into the **API Token** field. Leave **Username** and **Password** empty.

   - **Self-hosted Grafana**: paste the admin account's username and password into the **Username** and **Password** fields. Leave **API Token** empty.
</Step>
<Step>
Click **Save**.
</Step>
